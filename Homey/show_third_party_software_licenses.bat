...
"%~dp0msedgewebview2.exe" --embedded-browser-webview=show-credits --no-default-browser-check --no-first-run --disable-features=msImplicitSignin,msEdgeCollectionsUIFlag
